...
const Item: React.FC<AccordionItemProps> = ({
  ...
  return (
    <AccordionPrimitive.Item
      {...props}
      className={clx(
        "group border-t border-border last:mb-0 last:border-b",
        "py-3",
        className
      )}
    >
...
const MorphingTrigger = () => {
  return (
    <div className="text-muted-foreground hover:bg-background/50 active:bg-background/70 active:text-primary focus:border-primary disabled:text-muted-foreground/50 bg-transparent disabled:bg-transparent rounded-lg group relative p-[6px] transition-colors">
